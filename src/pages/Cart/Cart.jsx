...
//     console.log('Payload to delete:', item.id); // Add this line to log the payload
//     dispatch(deleteFromCart(item.id)); // Assuming item.id is the correct identifier
...
function Cart() {
  ...
  const buyNow = async () => {
    // Your buyNow logic here
    // Remember to include quantity in your orderInfo
  };
